...
export class CreateOneProductDto implements IProduct {
    ...
    @IsString({ message: 'La propiedad $property debe ser una string que contenga el ID del producto' })
    id: string;
    
    @IsNotEmpty({ message: 'La propiedad $property no debe ser nula' })
    @IsString({ message: 'La propiedad $property debe ser una string que contenga el titulo del producto' })
    title: string;
    
    @IsNotEmpty({ message: 'La propiedad $property no debe ser nula' })
    @IsString({ message: 'La propiedad $property debe ser una string que contenga la descripción del producto' })
    description: string;
    ...
    @IsNotEmpty({ message: 'La propiedad $property no debe ser nula' })
    @IsString({ message: 'La propiedad $property debe ser una string que contenga los links de las imagenes a poner sobre el porducto' })
    image: string;
    
    @IsNotEmpty({ message: 'La propiedad $property no debe ser nula' })
    @IsString({ message: 'La propiedad $property debe ser una string que contenga el modelo del producto' })
    model: string;
    
    @IsNotEmpty({ message: 'La propiedad $property no debe ser nula' })
    @IsString({ message: 'La propiedad $property debe ser una string que contenga el año del producto' })
    year: string;
