...
export class PaginateUsersDto {
    ...
    @IsNotEmpty({ message: 'La propiedad $property, debe contener un tipo de orden.' })
    @IsEnum(EOrderGetUsers, { message: `Puede contener las propiedades "${Object.values(EOrderGetUsers)}"` })
